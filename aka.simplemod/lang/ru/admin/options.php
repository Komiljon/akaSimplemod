...
$MESS["AKA_NO_SITE_INSTALLED"] = 'Не найдено сайтов с установленным решением &laquo;Aka: Next - Адаптивный интернет-магазин&raquo;<br />
...
$MESS["NEXT_MODULE_NOT_INSTALLED"] = 'Модуль &laquo;Aka: Next - Адаптивный интернет-магазин&raquo; не установлен. Пожалуйста, <a href="/bitrix/admin/partner_modules.php">установите модуль</a> и повторите попытку.';
...
$MESS["NO_SITE_INSTALLED"] = 'Не найдено сайтов с установленным решением &laquo;Aka: Маркет - Адаптивный интернет-магазин&raquo;<br />
<input type="button" value="Установить" style="margin-top: 10px;" onclick="document.location.href=\'/bitrix/admin/wizard_install.php?lang=ru&wizardName=aspro:next&#SESSION_ID#\'">';
